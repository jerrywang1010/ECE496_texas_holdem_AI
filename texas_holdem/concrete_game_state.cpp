...
{   
    ...
    for (unsigned i = 0; i < game->m_num_player; i ++)
    {
        ...
        current_player.add_to_hand( {game->m_cards[2 * i], game->m_cards[2 * i + 1]} );
...
{
    std::cout << "***************************************************************" << std::endl;
    std::cout << "Entering Pre Flop Round:\t" << "pot=" << game->m_pot << std::endl;
    std::cout << game->m_players[0].player_name << "'s balance=" << game->m_players[0].get_balance() << std::endl;
    std::cout << game->m_players[1].player_name << "'s balance=" << game->m_players[1].get_balance() << std::endl;
}

void Pre_flop::exit(Game* game)
{
    std::cout << "Exiting Pre Flop Round\t" << "pot=" << game->m_pot << std::endl << std::endl;
...
void Flop::enter(Game* game)
{
    ...
    check_allowed = true;
    std::cout << "***************************************************************" << std::endl;
    std::cout << "Entering Flop Round:\t" << "pot=" << game->m_pot << std::endl;
    std::cout << game->m_players[0].player_name << "'s balance=" << game->m_players[0].get_balance() << std::endl;
    std::cout << game->m_players[1].player_name << "'s balance=" << game->m_players[1].get_balance() << std::endl;
    ...
    {
        player.add_to_hand( {game->m_cards[4], game->m_cards[5], game->m_cards[6]} );
    }
}

void Flop::exit(Game* game)
{
    std::cout << "Exiting Flop Round\t" << "pot=" << game->m_pot << std::endl << std::endl;
    game->update_his_action();
    game->clear_round_action();
}
...
void Turn::enter(Game* game)
{
    ...
    check_allowed = true;
    std::cout << "***************************************************************" << std::endl;
    std::cout << "Entering Turn Round:\t" << "pot=" << game->m_pot << std::endl << std::endl;
    std::cout << game->m_players[0].player_name << "'s balance=" << game->m_players[0].get_balance() << std::endl;
    std::cout << game->m_players[1].player_name << "'s balance=" << game->m_players[1].get_balance() << std::endl;
    ...
    for (auto& player : game->m_players)
    {
        player.add_to_hand( {game->m_cards[7]} );
    }
}

void Turn::exit(Game* game)
{
    std::cout << "Exiting Turn Round\t" << "pot=" << game->m_pot << std::endl;
    game->update_his_action();
    game->clear_round_action();
}
...
void River::enter(Game* game)
{
    ...
    check_allowed = true;
    std::cout << "***************************************************************" << std::endl;
    std::cout << "Entering River Round:\t" << "pot=" << game->m_pot << std::endl << std::endl;
    std::cout << game->m_players[0].player_name << "'s balance=" << game->m_players[0].get_balance() << std::endl;
    std::cout << game->m_players[1].player_name << "'s balance=" << game->m_players[1].get_balance() << std::endl;
    ...
    for (auto& player : game->m_players)
    {
        player.add_to_hand( {game->m_cards[8]} );
    }
}

void River::exit(Game* game)
{
    std::cout << "Exiting River Round\t" << "pot=" << game->m_pot << std::endl;
    game->update_his_action();
    game->clear_round_action();
}
...
void Showdown::process(Game* game)
{
    ...
    uint16_t player_0_score = game->get_hand_ranking(game->m_players[0].get_hand());
    uint16_t player_1_score = game->get_hand_ranking(game->m_players[1].get_hand());

    if (player_0_score > player_1_score)
    {
        std::cout << game->m_players[0].player_name << " won the game, winning $" << game->m_pot << std::endl;
        game->m_loss_player_idx = 1;
    }
    else if (player_0_score < player_1_score)
    {
        std::cout << game->m_players[1].player_name << " won the game, winning $" << game->m_pot << std::endl;
...
{
    std::cout << "***************************************************************" << std::endl;
    std::cout << "Entering Showdown Round:\t" << "pot=" << game->m_pot << std::endl;
    std::cout << game->m_players[0].player_name << "'s balance=" << game->m_players[0].get_balance() << std::endl;
    std::cout << game->m_players[1].player_name << "'s balance=" << game->m_players[1].get_balance() << std::endl;
}
...
{
    std::cout << "Exiting Showdown Round\t" << "pot=" << game->m_pot << std::endl << std::endl;
}
...
{
    std::cout << "***************************************************************" << std::endl;
    std::cout << "Entering Terminal Round:\t" << "pot=" << game->m_pot << std::endl;
    std::cout << game->m_players[0].player_name << "'s balance=" << game->m_players[0].get_balance() << std::endl;
    std::cout << game->m_players[1].player_name << "'s balance=" << game->m_players[1].get_balance() << std::endl;
}
...
{
    std::cout << "Exiting Terminal Round\t" << "pot=" << game->m_pot << std::endl << std::endl;
}
